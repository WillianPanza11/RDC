...
var MenubarService = class _MenubarService {
  autoHide;
  autoHideDelay;
  mouseLeaves = new import_rxjs.Subject();
  mouseLeft$ = this.mouseLeaves.pipe((0, import_operators.debounce)(() => (0, import_rxjs.interval)(this.autoHideDelay)), (0, import_operators.filter)((mouseLeft) => this.autoHide && mouseLeft));
